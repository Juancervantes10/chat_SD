...
<head>
  ...
  <meta name="author" content="Juan Cervantes">
  <meta name="keyword" content="Web Developer Juan Cervantes">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="shortcut icon" type="image/png" href="assets/img/favicon.png" />
  <title>Juan Chat - Login</title>
...
<body>
  <section class="mi_wallper">
    ...
    <div class="login-box" id="login">
      <img src="assets/img/login-f.png" class="avatar mb-4" alt="Avatar Image">
      <p style="text-align: center; font-weight:600">INICIO DE SESION!
        <hr>
      </p>
      <div id="espacio"></div>
      ...
      <div class="group">
        <a style="float: right;" id="mostrar">No tienes una cuenta? Crea Tu Cuenta. .!</a>
      </div>
    </div>
    ...
    <div class="login-box" id="registrar">
      ...
      <img src="assets/img/login-f.png" class="avatar" alt="Avatar Image">
      <div id="espacio"></div>
